        ...
        */
        function addMouseWheelHandler(){
            ...
            if(support == 'DOMMouseScroll'){
                document[ _addEventListener ](prefix + 'MozMousePixelScroll', MouseWheelHandler, false, {passive: true});
            }

            //handle MozMousePixelScroll in older Firefox
            else{
                document[ _addEventListener ](prefix + support, MouseWheelHandler, false, {passive: true});
            }
        }
    ...
    if(typeof IScroll !== 'undefined'){
        ...
        */
        IScroll.prototype.wheelOn = function () {
            this.wrapper.addEventListener('wheel', this, {passive: true});
            this.wrapper.addEventListener('mousewheel', this, {passive: true});
